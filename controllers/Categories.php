...
use BackendMenu;
use Indikator\Newsletter\Models\Categories as Item;
...
class Categories extends Controller
{
    ...
    public $requiredPermissions = ['indikator.newsletter.categories'];
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Indikator.Newsletter', 'newsletter', 'categories');
    }
    ...
    public function onRemove()
    {
        if ($this->isSelected()) {
            foreach (post('checked') as $itemId) {
                ...
                Mails::where('category_id', $itemId)->update(['category_id' => 0]);
                Db::table('indikator_newsletter_relations')->where('categories_id', $itemId)->delete();
            }
