...
use Exception;
use Indikator\Newsletter\Models\Subscribers as Subscriber;
    ...
    public function defineProperties()
    {
        return [
            'title' => [
                ...
                'default'           => 'indikator.newsletter::lang.widget.subscribers',
                'type'              => 'string',
                'validationPattern' => '^.+$',
            ...
            'unsub' => [
                'title'   => 'indikator.newsletter::lang.widget.show_unsub',
                'default' => true,
                'type'    => 'checkbox'
            ],
            'pending' => [
                'title'   => 'indikator.newsletter::lang.widget.show_pending',
                'default' => true,
                'type'    => 'checkbox'
            ]
        ];
